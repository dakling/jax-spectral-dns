...
ffmpeg -y -framerate 5 -f image2  -pattern_type glob -i 'plots/plot_3d_z_velocity_x_t_*.png' -vcodec libx264 -crf 22 plots/vel_x.mp4
ffmpeg -y -framerate 5 -f image2  -pattern_type glob -i 'plots/plot_3d_z_velocity_y_t_*.png' -vcodec libx264 -crf 22 plots/vel_y.mp4
